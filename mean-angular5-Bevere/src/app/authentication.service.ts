...
This will use the Angular HttpClient service; 
*/  
...
/*It does require the map operator from RxJS in order to intercept and store the token in the service if it’s returned by an API login or register call. 
*/
